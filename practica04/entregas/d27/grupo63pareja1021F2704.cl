(defpackage :grupo63pareja1021F2704 	; se declara un paquete lisp que usa common-lisp
  (:use :common-lisp :mancala) 		; y mancala, y exporta la función de evaluación
  (:export :heuristica :*alias*)) 	; heurística y un alias para el torneo

(in-package grupo63pareja1021F2704)
    ...
    (+
     ...
     (if (juego-terminado-p estado)
       ...
       (+ (if (estado-debe-pasar-turno estado)
			(+ 	(tufunsionsita hoyo-0 hoyo-5-contrario)
...
(defun tufunsionsita (hoyo-propio hoyo-contrario)
	(if (not (= hoyo-contrario 0))
		0
	(* hoyo-contrario hoyo-contrario hoyo-contrario)))
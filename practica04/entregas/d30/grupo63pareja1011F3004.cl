(defpackage :grupo63pareja1011F3004 	; se declara un paquete lisp que usa common-lisp
  (:use :common-lisp :mancala) 		; y mancala, y exporta la función de evaluación
  (:export :heuristica :*alias*)) 	; heurística y un alias para el torneo

(in-package grupo63pareja1011F3004)
         ...
         (+ (* (- kalaha-propio kalaha-contrario) 500)
            ...
            (-
             ...
             (if (= hoyo-0-contrario 0)
                 500
               (- (* hoyo-5 hoyo-5) (* (+ hoyo-0-contrario 1) 5)))
             (if (= hoyo-1-contrario 0)
                 500
               (- (* hoyo-4 hoyo-4) (* (+ hoyo-1-contrario 1) 5)))
             (if (= hoyo-2-contrario 0)
                 500
               (- (* hoyo-3 hoyo-3) (* (+ hoyo-2-contrario 1) 5)))
             (if (= hoyo-3-contrario 0)
                 500
               (- (* hoyo-2 hoyo-2) (* (+ hoyo-3-contrario 1) 5)))
             (if (= hoyo-4-contrario 0)
                 500
               (- (* hoyo-1 hoyo-1) (* (+ hoyo-4-contrario 1) 5)))
             (if (= hoyo-5-contrario 0)
                 500
               (- (* hoyo-0 hoyo-0) (* (+ hoyo-5-contrario 1) 5))))))))))

(defvar *alias* '|Send_Nodes_1.5a|)
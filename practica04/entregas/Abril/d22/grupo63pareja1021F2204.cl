(defpackage :grupo63pareja1021F2204 	; se declara un paquete lisp que usa common-lisp
  (:use :common-lisp :mancala) 		; y mancala, y exporta la función de evaluación
  (:export :heuristica :*alias*)) 	; heurística y un alias para el torneo

(in-package grupo63pareja1021F2204)
     ...
     (if (juego-terminado-p estado)
       ...
       (if (estado-debe-pasar-turno estado)
         ...
         (+ (* (- kalaha-propio kalaha-contrario) 500)
            ;También miramos si el hoyo contrario tiene 0 fichas (en caso
            ;de tenerlas, ponderará muy negativamente ya que existe posibilidad
            ;de captura por parte del contrario).
            (-
             0
             (if (= hoyo-0-contrario 0)
                 500
               (- (* hoyo-5 hoyo-5) (* (+ hoyo-0-contrario 1) 11)))
             (if (= hoyo-1-contrario 0)
                 500
               (- (* hoyo-4 hoyo-4) (* (+ hoyo-1-contrario 1) 11)))
             (if (= hoyo-2-contrario 0)
                 500
               (- (* hoyo-3 hoyo-3) (* (+ hoyo-2-contrario 1) 51)))
             (if (= hoyo-3-contrario 0)
                 500
               (- (* hoyo-2 hoyo-2) (* (+ hoyo-3-contrario 1) 11)))
             (if (= hoyo-4-contrario 0)
                 500
               (- (* hoyo-1 hoyo-1) (* (+ hoyo-4-contrario 1) 11)))
             (if (= hoyo-5-contrario 0)
                 500
               (- (* hoyo-0 hoyo-0) (* (+ hoyo-5-contrario 1) 11))))))))))

(defvar *alias* '|Send_Nodes_1.1b|)
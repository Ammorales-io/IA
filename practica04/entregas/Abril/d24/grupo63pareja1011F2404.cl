(defpackage :grupo63pareja1011F2404	; se declara un paquete lisp que usa common-lisp
  (:use :common-lisp :mancala) 		; y mancala, y exporta la función de evaluación
  (:export :heuristica :*alias*)) 	; heurística y un alias para el torneo

(in-package grupo63pareja1011F2404)
     ...
     (if (juego-terminado-p estado)
       ...
       (if (estado-debe-pasar-turno estado)
         ...
         (+ (* (- kalaha-propio kalaha-contrario) 500)
            ...
            (-
             0
             (- (* hoyo-0 hoyo-0) (* (+ hoyo-5-contrario 1) 25))
             (- (* hoyo-1 hoyo-1) (* (+ hoyo-4-contrario 1) 25))
             (- (* hoyo-2 hoyo-2) (* (+ hoyo-3-contrario 1) 25))
             (- (* hoyo-3 hoyo-3) (* (+ hoyo-2-contrario 1) 25))
             (- (* hoyo-4 hoyo-4) (* (+ hoyo-1-contrario 1) 25))
             (- (* hoyo-5 hoyo-5) (* (+ hoyo-0-contrario 1) 25)))))))))


(defvar *alias* '|Petabuses_v1.2a|)